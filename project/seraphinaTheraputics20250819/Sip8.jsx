...
const arraySave=[
"",
"Save an extra 15% with code RICKI",
"Save an extra 15% with code DRDREW",
"Save an extra 15% with code SHAUNT",
"Save an extra 15% with code BARBARA",
"Save an extra 15% with code THOMAS",
];

const stringSave=arraySave[5];
...
const styleMore={
  ...
  return (
    <>
      ...
      <Card>
        <Card {...x36}>36+</Card>
        <Card {...cellular}> cellular benefits that support:</Card>
        <Card {...a1}><span className="circle" style={{...styleMore,paddingTop:"12px"}}> &nbsp;&nbsp;&nbsp;Healthy metabolism</span></Card>
        <Card {...a2}><span className="circle" style={{...styleMore,paddingTop:"12px"}}> &nbsp;&nbsp;&nbsp;Red blood cell health</span></Card>
        <Card id={"a3"} {...a3}><span className="circle circle-3" style={{...styleMore,paddingTop:"1px"}}> &nbsp;&nbsp;&nbsp;Cognitive & liver health</span></Card>

        <Card {...button}>Shop Now</Card>
      </Card>
    
      <Card {...save}>{stringSave}</Card>
      <Card {...indication}>
