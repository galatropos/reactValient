...
const configActive = {
  ...
  return (
    <>
      ...
      <Card {...configText1} />
      <Card {...configText2} />
      <Request index={0} xLandscape={56.4} yLandscape={80} xPortrait={50} yPortrait={77} />
      <Request index={1} xLandscape={73.2} yLandscape={80} xPortrait={20} yPortrait={77} />
      <Request index={2} xLandscape={90} yLandscape={80} xPortrait={80} yPortrait={77} />
    <Card {...configActive} />
    </>
  );
};
